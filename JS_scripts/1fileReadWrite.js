...
// say /dirImages/1.png 2.png....100.png files,so we've 100 images and wanted to fetch & write only name of file in separate file say output.txt
// Line Nos. with 🚩 need to be changed as per your path
...
const readWriteFile = ()=>{
    try{
        ...
        return new Promise((resolve, reject)=>{
            //read files
            fs.readdir(dirName, (err, files)=>{  //'files' consist all .png file names in array
